  ...
  return (
    ...
    <Card shadow="lg" className="max-w-[400px] antialiased">
      ...
      <ButtonGroup>
        ...
        <Link href="/">
        <Button isIconOnly size="lg" color="warning" radius="sm"><BackIcon /></Button>
        </Link>
        <Button isIconOnly size="lg" color="secondary" radius="sm" onClick={replayGame} ><ReplayIcon /></Button>
      </ButtonGroup>
      </CardFooter>
    </Card>
    </>
